...
const tableName = 'admin.products_by_branches';

export class ProductsByBranchesMigration1764984877755 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.createUniqueConstraint(
            tableName,
            new TableUnique({
                name: 'UQ_products_by_branches_product_branch',
